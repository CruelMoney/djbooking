...
const Money = ({altGradient, ...props}) => (
  <svg width={68} height={68} viewBox="0 0 68 68" {...props}>
    ...
    <defs>
      ...
      <linearGradient x1="114.218236%" y1="114.496747%" x2="15.4768336%" y2="27.880475%" id="b">
          <stop stop-color="#31FFF5" offset="0%"></stop>
          <stop stop-color="#31FFC5" offset="21.7952806%"></stop>
          <stop stop-color="#00D1FF" offset="87.5640132%"></stop>
